...
INSERT INTO `account` (Email, Username, Fullname, DepartmentID, PositionID, CreatedDate)
	VALUES ('vti_account1@vtiacademy.com', 'vti1', 'Dinh Van Dao', 1, 1, '2019-12-01'),
...
SELECT * FROM `group` WHERE CreatedDate < '2019-12-20';
...
/*Q14: Update thông tin của account có id = 5 thành tên "Nguyễn Bá Lộc" và
